...
from bacon.utils.strings import \
	bsescape, bsunescape, bssplit, ensure_unicode, quote_plus
...
class UrlQueryBuilder(QueryBuilder):
	...
	def __init__(self, context, cubedef=None,
			base_url=None, query_location=IN_QUERY, **kwargs):
	...
	def get_query_string(self, name):
		if (self.query_location == self.IN_QUERY or
				self.query_location == self.IN_FRAGMENT):
