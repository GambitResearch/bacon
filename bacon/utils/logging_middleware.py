...
class LoggingMiddleware(MiddlewareMixin):
	...
	def __init__(self, logger=None, format=None, logging_level=logging.INFO,
			logger_name='wsgi', setup_console_handler=True,
			set_logger_level=logging.DEBUG, disable_on_devel=True):
